...
//        EmasOptions options1 = new EmasOptions.Builder()
//                .setAccsOptions(new AccsOptions.Builder()
//                        .setDomain(einfo.ACCS.Domain).build())
...
//                .setAppkey(einfo.getAppKey())
//                .setAppSecret(einfo.AppSecret)
//                .setChannelId(einfo.ChannelID)
//                .setUseHttp(einfo.UseHTTP)
//                .setAutoStartSdks(null)
//                .setZCacheOptions(new ZCacheOptions.Builder().setDomain(einfo.ZCache.URL).build())
//                .build();
//        EmasClient.init(mContext.getApplicationContext());
